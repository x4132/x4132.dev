...
import { EVENT_SPAWNERS, type EventConfig } from "./events/spawners";
...
function selectEventType(): EventType {
  const activeEvents = EVENT_WEIGHTS.filter((e) => e.weight > 0);
...
/**
 * Event manager component - handles spawning outside of Canvas
 */
function EventManager({
  ...
  useEventSpawner(config, spawnInterval, maxActiveEvents);
  return null;
}
